...
<YouTube videoId="7SIjcX5B1Vs" />

> 来源状态：已按完整节目复核；节目观点与外部证据分开呈现。

本文依据 Huberman 与 Bret Contreras 的完整节目对话整理。节目观点与外部证据分开呈现；本文用于体型训练知识库，不替代运动损伤康复或营养治疗。
...
3. **弱项可用更高优先级训练**：节目讨论了把目标部位放在精力最好时、用稳定动作和可追踪的个人纪录逐步增加刺激；训练频率仍需按恢复调整。
...
- 节目中的“两次全身训练是很多人的起点”“三组或两组”等是 Contreras 的实践建议，不是对所有人都适用的处方。2025 ACSM 综述支持渐进抗阻训练，但也强调目标、负荷、训练量和个体条件共同决定结果（[PubMed](https://pubmed.ncbi.nlm.nih.gov/41843416/)）。
- 局部增肌与局部减脂要分开：臀肌可以通过训练获得局部肌肥大线索，但脂肪减少主要是全身能量平衡，不能靠某个动作“定点减脂”。
