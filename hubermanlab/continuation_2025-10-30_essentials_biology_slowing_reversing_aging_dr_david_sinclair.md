...
<YouTube videoId="Ykvkg2Jz3X8" />

> 来源状态：已按完整节目复核；节目观点与外部证据分开呈现。

本文依据 Huberman 与 David Sinclair 的完整节目讲解整理。节目观点与外部证据分开呈现；本文用于衰老生物学知识库，不构成 NMN、药物或抗衰治疗建议。
...
2. **把 NAD 相关补剂放在证据边界内**：节目讨论 NMN、NR 和 NAD 代谢路径，但“提高 NAD”并不等于已证明延长人类寿命或降低疾病风险。
...
- NIA 的衰老干预项目仍把许多化合物放在动物或早期转化研究中，说明“抗衰机制”与人类临床处方之间有明显距离（[NIA ITP](https://www.nia.nih.gov/research/resource/interventions-testing-program-itp)）。
- 本页不把 Sinclair 的个人观点、动物数据或补剂营销当作临床共识；对二甲双胍、雷帕霉素、激素和 NAD 前体的使用必须有明确适应证、监测和医生参与。
